...
Fig.~\ref{fig:flow} is the five-layer governed deployment stack; Fig.~\ref{fig:seq} the request sequence; Fig.~\ref{fig:net} the deployment network (C4 container view).
\begin{figure}[h]\centering
\resizebox{\columnwidth}{!}{%
...
\caption{Five-layer governed deployment stack.}\label{fig:flow}\end{figure}
\begin{figure}[h]\centering
\resizebox{\columnwidth}{!}{%
